                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            ...
                            <div class="col-sm-6 text-right">
                                <?php if(checkModulePermission(15,2)){ ?>
                                    <a href="<?= $main_page ?>/addedit" class="btn btn-primary">Add <?= $heading ?></a>
                                <?php } ?>
                                <?php if(checkModulePermission(15,4)){ ?>
                            ...
                            <div class="table-responsive">
                                <table id="mytable" class="table table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <?php } ?>
                                        <th>Planning Sheets ID.</th>
                                        <th>Planning Sheets Date</th>
                                        <th>Manufacturer</th>
                                        <?php if(checkModulePermission(15,5)){ ?>
                                            <th>Total Cost</th>
                                        <?php }?>
                                        <th>Total Area</th>
                                    ...
                                    if($resultList){
                                        foreach ($resultList as  $value) {
                                            ...
                                            ?>
                                            <tr <?php if(checkModulePermission(15,2)){ ?> class='clickable-row' data-href="<?= $main_page ?><?= ($value->is_pi==1)?'/view/':'/addedit/'?><?= md5($ID) ?>" <?php }?> style="cursor: pointer;" >
                                                <?php if(checkModulePermission(15,4)){ ?>
                                                    <td><input type="checkbox" class="checkboxitem" value="<?= $ID ?>" name="item_ids[]"> </td>
                                                <?php } ?>
                                                <td><?= $value->sheetsid ?></td>
                                                <td><?= dateFormate($value->planningsheets_date,"m/d/Y") ?></td>
