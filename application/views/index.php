...
<div class="login-box">
  <div class="login-logo"><b>Login Panel</a>
  </div>
  <!-- /.login-logo -->
    ...
    <?= form_open_multipart('', 'class="myform" id="myform"'); ?>
      ...
      <div class="form-group has-feedback">
        <div class="input-group col-sm-12">
          <input type="email" id="email" name="email" class="form-control email required" placeholder="Enter Email" value="<?= getFieldVal('email',$credential) ?>">
      ...
      <div class="form-group has-feedback">
        <div class="input-group col-sm-12">
          <input type="password" id="password" name="pwd" class="form-control required" placeholder="Enter Password" value="<?= getFieldVal('password',$credential) ?>">
      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              <input type="checkbox" <?php if(!empty($credential)){echo "checked";}?>  name="rememberme" value="1"> Remember Me
            </label>
          </div>
        </div>
        <!-- /.col -->
