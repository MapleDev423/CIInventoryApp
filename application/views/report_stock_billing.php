                ...
                ?>
                   ...
                   <tfoot style="font-weight:bold;">
			            <tr>
							...
							<td><span></span><span id="pageNetBillingTotal"></span></td>
							<td><span></span><span id="page_total"></span></td>
			            </tr>
						 <tr>
							<td colspan="5" style="text-align:right">Grand Total :</td>
							<td><span></span><span id="grand_netBillingTotal"></span></td>
...
$('#mytable').DataTable( {
        ...
        "footerCallback": function ( row, data, start, end, display ) {
			...
			// Net Billing Grand Total over all pages
			netBillingTotal= api
                .column(5)
                .data()
                .reduce( function (a, b) {
            ...
            // Net Billing Total over this page
            pageNetBillingTotal= api
			...
			// Update footer
			$('#pageNetBillingTotal').html(pageNetBillingTotal.toFixed(2));	
			$('#grand_netBillingTotal').html(netBillingTotal.toFixed(2));
...
$("#excel").on("click", function(){ 
	$("#tableForm").attr('action', 'csv_for_stock_billing_report');
	tableForm.submit();
});
